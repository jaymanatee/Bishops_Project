...
class NERLoss(torch.nn.Module):
    def __init__(self, ner_weight=1.0, o_tag_penalty=0.3):
...
class NERAccuracy(torch.nn.Module):
    def __init__(self, ner_threshold=0.5, sa_threshold=0.5):
        super(NERAccuracy, self).__init__()
...
class SALoss(torch.nn.Module):
    def __init__(self, sa_weight=1.0):
    ...
    def forward(self, ner_logits, ner_labels, sa_logits, sa_labels):
        ...
        total_loss = self.sa_weight * sa_loss
        return total_loss
    

class SAAccuracy(torch.nn.Module):
    def __init__(self, sa_threshold=0.5):
        super(SAAccuracy, self).__init__()
